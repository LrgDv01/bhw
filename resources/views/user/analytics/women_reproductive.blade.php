...
<main id="main" class="main">
     <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.summary-list.wreproductive-age') }}" 
                    class="{{ Request::is('admin/summary-list/wreproductive-age') ? 'active' : '' }}">Woman in Reproductive Age</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.analytics.wreproductive-age') }}" 
                    class="{{ Request::is('admin/analytics/wreproductive-age') ? 'active' : '' }}">Analytics</a></li>
            </ol>
        </nav>
    </div>
    <section class="section analytic mt-4">
        ...
        <h2 class="text-center"><strong>Woman in Reproductive Age Anaytics</strong></h2>
        <div class="row mt-3">
            <div class="col">
                        ...
                        <div class="card women">
                            <div class="card-body p-3">
                                <div id="chart" style="width: 100%; height:auto; margin: auto; ">
                                    <canvas id="womenReproductiveGroup"></canvas>
                                </div>
                            </div>
                            <div class="d-flex flex-row justify-content-center">
                                <button id="womenReproductiveGroupResetZoomBtn" class="btn btn-outline-secondary mb-2 btn-sm rounded rounded-3">Default View</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card women">
                            <div class="card-body p-3">
                                <div id="chart" style="width: 100%; height:auto; margin: auto; ">
                                    <canvas id="totalWomenReproductive"></canvas>
                                </div>
                            </div>
                            <div class="d-flex flex-row justify-content-center">
                                <button id="totalWomenReproductiveResetZoomBtn" class="btn btn-outline-secondary mb-2 btn-sm rounded rounded-3">Default View</button>
                            </div>
                        </div>
                    </div>
                </div>
