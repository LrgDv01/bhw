...
<main id="main" class="main">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.summary-list.census') }}" 
                    class="{{ Request::is('admin/summary-list/census') ? 'active' : '' }}">Deworming</a></li>
    ...
    <section class="section analytic mt-4">
        ...
        <h2 class="text-center"><strong>Deworming Anaytics</strong></h2>
        <div class="row mt-3">
            <div class="col">
                <div class="row py-0 my-0">
                        ...
                        <div class="card deworming">
                            <div class="card-body p-3">
                                <div style="width: 100%; height:auto; margin: auto;">
                                    <div id="dewormingBeneficiaries" style="height: 370px; width: 100%;"></div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="card deworming-analytics">
                            <div class="card-body p-3">
