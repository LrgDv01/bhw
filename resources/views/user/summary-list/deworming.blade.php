    ...
    <div class="pagetitle mb-3">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.summary-list.deworming') }}" 
                    class="{{ Request::is('admin/summary-list/deworming') ? 'active' : '' }}">Deworming</a></li>
            </ol>
        </nav>
    </div>
    <section class="section family-planning">
    <div class="mt-3">
        <h2 class="text-center"><strong>Deworming Report</strong></h2>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-primary rounded rounded-3">
                <a class="text-white" href="{{route('admin.analytics.deworming')}}">View Analytics</a>
            </button>
        </div>
    </div>
