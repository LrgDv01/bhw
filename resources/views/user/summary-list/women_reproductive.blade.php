...
<main id="main" class="main">
    ...
    <div class="mt-3">
        <h2 class="text-center"><strong>Woman in Reproductive Age Report</strong></h2>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-primary rounded rounded-3">
                <a class="text-white" href="{{route('admin.analytics.wreproductive-age')}}">View Analytics</a>
            </button>
        </div>
    </div>
