...
<main id="main" class="main">
    <div class="pagetitle mb-3">
        <h1 class="fs-3"><strong>Deworming</strong></h1>
    </div>
    <section class="section family-planning">
    <div class="mt-3">
        <h2 class="text-center"><strong>Record List</strong></h2>
            ...
            <form action="{{ route('bhw.deworming.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-between">   
                    ...
                    <div class="w-25 justify-content-end">
                        <button type="submit" class="btn btn-success rounded rounded-3 fs-5 me-5"><i class="bi bi-plus"></i><strong>Add</strong></button>
                    </div>   
                </div>
            </form>
        </div> --}}
